...
class CardTest {
    ...
    @Test
    void should_remove_new_lines_in_titles() {
    ...
    @Test
    void should_remove_new_line_in_back() {
    ...
    @Test
    void should_remove_new_lines_in_back() {
        Card card = new Card("", new Category("", ""), "\n\n", "some back\n\n");
    ...
    @Test
    void should_remove_html_paragraph_in_back() {
        Card card = new Card("", new Category("", ""), "\n\n", "<p>some back</p>\n");
    ...
    @Test
    void should_remove_html_paragraphs_in_back() {
        Card card = new Card("", new Category("", ""), "\n\n", "<p>some</p>\n<p>back</p>\n");
    ...
    @Test
    void should_replace_html_ul_and_li_in_back() {
        Card card = new Card("", new Category("", ""), "\n\n", "" +
                "<ul>\n" +
